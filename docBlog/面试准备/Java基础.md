...
## 谈谈你对 JVM JDK 和 JRE 的理解(JDK 和 JRE 的区别是什么?)。什么是字节码?为什么要采用字节码?
...
![img](https://images.xiaozhuanlan.com/photo/2020/107bafc240fa742b94698dca1044f896.jpg)
...
str 和 str1 不相等，因为一个是堆内存中的 String 对象一个是常量池中的 String 对象。
